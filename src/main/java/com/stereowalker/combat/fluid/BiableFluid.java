...
public abstract class BiableFluid extends FlowingFluid {
	...
	public BlockState getBlockState(FluidState state) {
		return CBlocks.BIABLE.getDefaultState().with(FlowingFluidBlock.LEVEL, Integer.valueOf(getLevelFromState(state)));
	}
	...
	public boolean func_215665_a(FluidState p_215665_1_, IBlockReader p_215665_2_, BlockPos p_215665_3_, Fluid p_215665_4_, Direction p_215665_5_) {
		return p_215665_5_ == Direction.DOWN && !p_215665_4_.isIn(FluidCTags.BIABLE);
	}
