...
public class WoodcutterContainer extends Container {
   ...
   public WoodcutterContainer(int windowIdIn, PlayerInventory playerInventoryIn, final IWorldPosCallable worldPosCallableIn) {
      super(CContainerType.WOODCUTTER, windowIdIn);
   ...
   public boolean canInteractWith(PlayerEntity playerIn) {
      return isWithinUsableDistance(this.worldPosCallable, playerIn, CBlocks.WOODCUTTER);
   }
   ...
   private void updateAvailableRecipes(IInventory inventoryIn, ItemStack stack) {
      ...
      if (!stack.isEmpty()) {
         this.recipes = this.world.getRecipeManager().getRecipes(CRecipeType.WOODCUTTING, inventoryIn, this.world);
      }
   ...
   public ContainerType<?> getType() {
      return CContainerType.WOODCUTTER;
   }
   ...
   public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
      ...
      if (slot != null && slot.getHasStack()) {
         ...
         } else if (this.world.getRecipeManager().getRecipe(CRecipeType.WOODCUTTING, new Inventory(itemstack1), this.world).isPresent()) {
