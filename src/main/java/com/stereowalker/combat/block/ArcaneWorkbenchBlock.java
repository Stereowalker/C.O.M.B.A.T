...
public class ArcaneWorkbenchBlock extends /* Container */Block {
	private static final ITextComponent NAME = new TranslationTextComponent("container.arcane_workbench");
...
//	}
	...
	public INamedContainerProvider getContainer(BlockState state, World worldIn, BlockPos pos) {
		return new SimpleNamedContainerProvider((p_220270_2_, p_220270_3_, p_220270_4_) -> {
			return new ArcaneWorkbenchContainer(p_220270_2_, p_220270_3_, IWorldPosCallable.of(worldIn, pos));
		}, NAME);
	}
