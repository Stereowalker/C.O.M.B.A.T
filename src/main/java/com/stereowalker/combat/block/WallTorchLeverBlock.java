...
public class WallTorchLeverBlock extends TorchLeverBlock {
	...
	public WallTorchLeverBlock(AbstractBlock.Properties properties, IParticleData particleData) {
	...
	protected void updateNeighbors(BlockState p_196378_1_, World p_196378_2_, BlockPos p_196378_3_) {
		...
		p_196378_2_.notifyNeighborsOfStateChange(p_196378_3_.offset(p_196378_1_.get(HORIZONTAL_FACING).getOpposite()), this);
	}
