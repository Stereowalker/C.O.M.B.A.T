...
public class FletchingRecipe implements IFletchingRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingInventory> {
	...
	public FletchingRecipe(ResourceLocation idIn, String groupIn, int recipeWidthIn, int recipeHeightIn, NonNullList<Ingredient> recipeItemsIn, ItemStack recipeOutputIn) {
		this.id = idIn;
		this.group = groupIn;
	...
	public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>>  implements IRecipeSerializer<FletchingRecipe> {
		...
		public FletchingRecipe read(ResourceLocation recipeId, JsonObject json) {
			...
			Map<String, Ingredient> map = FletchingRecipe.deserializeKey(JSONUtils.getJsonObject(json, "key"));
			String[] astring = FletchingRecipe.shrink(FletchingRecipe.patternFromJson(JSONUtils.getJsonArray(json, "pattern")));
			int i = astring[0].length();
			int j = astring.length;
			NonNullList<Ingredient> nonnulllist = FletchingRecipe.deserializeIngredients(astring, map, i, j);
			ItemStack itemstack = FletchingRecipe.deserializeItem(JSONUtils.getJsonObject(json, "result"));
			return new FletchingRecipe(recipeId, s, i, j, nonnulllist, itemstack);
		}
