...
public class MythrilHoeItem extends HoeItem implements IMythrilItem {

	private float attackSpeed;

	public MythrilHoeItem(IItemTier itemTier, int attackDamage, float attackSpeed, Item.Properties properties) {
