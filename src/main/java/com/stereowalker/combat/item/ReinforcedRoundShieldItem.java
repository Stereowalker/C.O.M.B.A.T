...
public class ReinforcedRoundShieldItem extends ShieldCItem implements IReinforcedItem {
	private IItemTier tier;

	public ReinforcedRoundShieldItem(Properties builder, IItemTier tier) {
