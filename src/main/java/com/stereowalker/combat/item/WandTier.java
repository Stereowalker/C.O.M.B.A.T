...
public enum WandTier implements IWandTier {
	...
	private WandTier(int spellSlotsIn, int maxUsesIn, float strengthModifierIn, float costModifierIn, int enchantabilityIn) {
