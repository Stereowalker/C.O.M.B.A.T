...
import com.stereowalker.combat.tileentity.DisenchantingTableTileEntity;
...
@OnlyIn(Dist.CLIENT)
public class DisenchantmentTableTileEntityRenderer extends TileEntityRenderer<DisenchantingTableTileEntity> {
	...
	public DisenchantmentTableTileEntityRenderer(TileEntityRendererDispatcher p_i226010_1_) {
		super(p_i226010_1_);
	}

	public void render(DisenchantingTableTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
		matrixStackIn.push();
