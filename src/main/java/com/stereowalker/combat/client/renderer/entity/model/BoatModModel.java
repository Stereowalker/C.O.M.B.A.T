...
@OnlyIn(Dist.CLIENT)
public class BoatModModel extends SegmentedModel<BoatModEntity> {
   ...
   @Override
   public void setRotationAngles(BoatModEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(BoatModEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
