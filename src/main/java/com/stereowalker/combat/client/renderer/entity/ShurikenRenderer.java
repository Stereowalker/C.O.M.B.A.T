...
public class ShurikenRenderer extends EntityRenderer<Shuriken> {
	...
	public void render(Shuriken entity, float entityYaw, float p_225623_3_, PoseStack matrixStack, MultiBufferSource typeBuffer, int packedLight) {
		...
		matrixStack.mulPose(Axis.YP.rotationDegrees(Mth.lerp(p_225623_3_, entity.yRotO, entity.getYRot()) - 90.0F));
		matrixStack.mulPose(Axis.YP.rotationDegrees(Mth.lerp(p_225623_3_, entity.xRotO, entity.getXRot()) + 180.0F));
