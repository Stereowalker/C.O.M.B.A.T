...
public class DaggerRenderer extends EntityRenderer<DaggerEntity> {
	...
	public DaggerRenderer(EntityRendererManager renderManagerIn) {
		super(renderManagerIn);
	}

	@Override
	public void render(DaggerEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		matrixStackIn.push();
	...
	public ResourceLocation getEntityTexture(DaggerEntity entity) {
		return null;
	}
}