...
public class BatteryChargerScreen extends AbstractContainerScreen<BatteryChargerMenu>{
	...
	public BatteryChargerScreen(BatteryChargerMenu crateContainer, Inventory playerInventory, Component title) {
	...
	protected void renderBg(PoseStack matrixStack, float partialTicks, int mouseX, int mouseY) {
		...
		if (((BatteryChargerMenu)this.menu).hasEnergy()) {
			int k = ((BatteryChargerMenu)this.menu).getEnergyScaled();
