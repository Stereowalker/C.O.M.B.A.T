...
public class BatteryChargerScreen extends ContainerScreen<BatteryChargerContainer>{
	...
	public BatteryChargerScreen(BatteryChargerContainer crateContainer, PlayerInventory playerInventory, ITextComponent title) {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
		...
		if (((BatteryChargerContainer)this.container).hasEnergy()) {
			int k = ((BatteryChargerContainer)this.container).getEnergyScaled();
