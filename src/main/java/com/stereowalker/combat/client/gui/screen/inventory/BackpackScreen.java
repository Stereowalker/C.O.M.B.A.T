...
public class BackpackScreen extends ContainerScreen<BackpackContainer>{
	private static final ResourceLocation GUI_TEXTURE = Combat.getInstance().location("textures/gui/container/backpack.png");

	public BackpackScreen(BackpackContainer crateContainer, PlayerInventory playerInventory, ITextComponent title) {
