...
@OnlyIn(Dist.CLIENT)
public class FletchingScreen extends ContainerScreen<FletchingContainer> implements IRecipeShownListener {
	...
	public void render(MatrixStack matrixStack, int p_render_1_, int p_render_2_, float p_render_3_) {
		...
		if (this.recipeBookGui.isVisible() && this.widthTooNarrow) {
			...
			this.recipeBookGui./*renderGhostRecipe*/func_230477_a_(matrixStack, this.guiLeft, this.guiTop, true, p_render_3_);
		}

		this.renderHoveredTooltip(matrixStack, p_render_1_, p_render_2_);
		this.recipeBookGui./*renderTooltip*/func_238924_c_(matrixStack, this.guiLeft, this.guiTop, p_render_1_, p_render_2_);
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
		...
		this.minecraft.getTextureManager().bindTexture(FLETCHING_TABLE_GUI_TEXTURES);
		int i = this.guiLeft;
