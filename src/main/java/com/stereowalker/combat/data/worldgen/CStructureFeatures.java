...
public class CStructureFeatures {
	public static final Holder<ConfiguredStructureFeature<?, ?>> ETHERION_TOWER = StructureFeatures.register(CombatStructures.ETHERION_TOWER, CStructureFeature.ETHERION_TOWER.configured(new EtherionTowerConfiguration(Config.SERVER.etherionTowerProbability.get().floatValue(), EtherionTowerConfiguration.Variant.OVERWORLD), BiomeCTags.HAS_ETHERION_TOWER));
	public static final Holder<ConfiguredStructureFeature<?, ?>> ETHERION_TOWER_BADLANDS = StructureFeatures.register(CombatStructures.ETHERION_TOWER_BADLANDS, CStructureFeature.ETHERION_TOWER.configured(new EtherionTowerConfiguration(Config.SERVER.etherionTowerProbability.get().floatValue(), EtherionTowerConfiguration.Variant.BADLANDS), BiomeCTags.HAS_ETHERION_TOWER_BADLANDS));
	public static final Holder<ConfiguredStructureFeature<?, ?>> ETHERION_TOWER_DESERT = StructureFeatures.register(CombatStructures.ETHERION_TOWER_DESERT, CStructureFeature.ETHERION_TOWER.configured(new EtherionTowerConfiguration(Config.SERVER.etherionTowerProbability.get().floatValue(), EtherionTowerConfiguration.Variant.DESERT), BiomeCTags.HAS_ETHERION_TOWER_DESERT));
	public static final Holder<ConfiguredStructureFeature<?, ?>> ETHERION_TOWER_ACROTLEST = StructureFeatures.register(CombatStructures.ETHERION_TOWER_ACROTLEST, CStructureFeature.ETHERION_TOWER.configured(new EtherionTowerConfiguration(Config.SERVER.etherionTowerProbability.get().floatValue(), EtherionTowerConfiguration.Variant.ACROLEST), BiomeCTags.HAS_ETHERION_TOWER_ACROTLEST));
