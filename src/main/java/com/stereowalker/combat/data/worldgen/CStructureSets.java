...
public interface CStructureSets {
	Holder<StructureSet> ETHERION_TOWERS = StructureSets.register(CombatStructureSets.ETHERION_TOWERS, new StructureSet(List.of(StructureSet.entry(CStructureFeatures.ETHERION_TOWER), StructureSet.entry(CStructureFeatures.ETHERION_TOWER_ACROTLEST)), new RandomSpreadStructurePlacement(200, 100, RandomSpreadType.LINEAR, 53060063)));
