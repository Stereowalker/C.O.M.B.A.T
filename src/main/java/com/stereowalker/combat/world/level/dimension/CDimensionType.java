...
public class CDimensionType {
	...
	protected static final DimensionType ACROTLEST_TYPE = DimensionType.create(OptionalLong.empty(), true, false, false, true, 1.0D, false, false, true, false, true, -512, 512, 512, FuzzyOffsetConstantColumnBiomeZoomer.INSTANCE, BlockTags.INFINIBURN_OVERWORLD.getName(), ACROTLEST_ID, 0.0F);
