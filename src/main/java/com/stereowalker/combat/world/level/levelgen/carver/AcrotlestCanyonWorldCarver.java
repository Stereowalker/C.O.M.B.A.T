...
import static net.minecraft.world.level.levelgen.carver.WorldCarver.isDebugEnabled;
...
public class AcrotlestCanyonWorldCarver extends CanyonWorldCarver {
	...
	@Override
	protected boolean carveBlock(CarvingContext pContext, CanyonCarverConfiguration pConfig, ChunkAccess pChunk, Function<BlockPos, Biome> pBiomeAccessor, BitSet pCarvingMask, Random pRandom, BlockPos.MutableBlockPos pPos, BlockPos.MutableBlockPos pCheckPos, Aquifer pAquifer, MutableBoolean pReachedSurface) {
	...
	//	@Override
	//	protected boolean carveBlock(IChunk chunk, Function<BlockPos, Biome> biomePos, BitSet carvingMask, Random rand, BlockPos.MutableBlockPos p_225556_5_, BlockPos.MutableBlockPos p_225556_6_, BlockPos.MutableBlockPos p_225556_7_, int p_225556_8_, int p_225556_9_, int p_225556_10_, int p_225556_11_, int p_225556_12_, int p_225556_13_, int p_225556_14_, int p_225556_15_, MutableBoolean p_225556_16_) {
