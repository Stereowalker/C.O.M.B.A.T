...
public class CNoiseGeneratorSettings {
	public static final ResourceKey<NoiseGeneratorSettings> ACROTLEST = ResourceKey.create(Registries.NOISE_SETTINGS, new ResourceLocation(Combat.MODID, "acrotlest"));
