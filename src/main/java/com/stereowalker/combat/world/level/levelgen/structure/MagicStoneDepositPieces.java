...
public class MagicStoneDepositPieces {
	...
	public static void addPieces(StructureTemplateManager templateManager, BlockPos blockPos, Rotation rotation, StructurePieceAccessor pPieces, RandomSource random) {
