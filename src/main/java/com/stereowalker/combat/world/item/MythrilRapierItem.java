...
public class MythrilRapierItem extends RapierItem implements Mythril {
	private final float attackSpeed;

	public MythrilRapierItem(Tier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn) {
