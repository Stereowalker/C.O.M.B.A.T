...
public class MythrilKatanaItem extends KatanaItem implements Mythril {
	private final float attackSpeed;

	public MythrilKatanaItem(Tier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn) {
