...
public class AccessoryItemCheck {
	...
	public static ItemStack getOtherInventories(Player player, int slot) {
		if (slot != 3 && slot != 6 && slot >= 0 && slot < 9) {
			return UnionLib.getAccessoryInventory(player).getItem(slot);
		}
	 ...
	 */
//	@Deprecated
//	public ItemStack getEquippedRing(Player player) {
