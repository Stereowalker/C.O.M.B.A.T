...
public class CEnchantmentCategory {
	...
	public static final EnchantmentCategory EDGELESS = EnchantmentCategory.create("edgeless", (item) -> new ItemStack(item).is(ItemCTags.EDGELESS_THRUSTING_WEAPON));
	public static final EnchantmentCategory CURVED = EnchantmentCategory.create("curved", (item) -> new ItemStack(item).is(ItemCTags.SINGLE_EDGE_CURVED_WEAPON));
