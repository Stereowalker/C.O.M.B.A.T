...
public class CItems {
	...
	public static final Item PYROMANCER_RING = register("pyromancer_ring", new AffinityRingItem(new Item.Properties().tab(CCreativeModeTab.MAGIC).stacksTo(1)));
	public static final Item HYDROMANCER_RING = register("hydromancer_ring", new AffinityRingItem(new Item.Properties().tab(CCreativeModeTab.MAGIC).stacksTo(1)));
	public static final Item ELECTROMANCER_RING = register("electromancer_ring", new AffinityRingItem(new Item.Properties().tab(CCreativeModeTab.MAGIC).stacksTo(1)));
	public static final Item TERRAMANCER_RING = register("terramancer_ring", new AffinityRingItem(new Item.Properties().tab(CCreativeModeTab.MAGIC).stacksTo(1)));
	public static final Item AEROMANCER_RING = register("aeromancer_ring", new AffinityRingItem(new Item.Properties().tab(CCreativeModeTab.MAGIC).stacksTo(1)));
