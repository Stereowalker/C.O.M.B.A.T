...
public class MythrilDaggerItem extends DaggerItem implements Mythril {
	private final float attackSpeed;

	public MythrilDaggerItem(Tier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn) {
