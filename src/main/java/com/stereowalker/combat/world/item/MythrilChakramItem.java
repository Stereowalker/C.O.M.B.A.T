...
public class MythrilChakramItem extends ChakramItem implements Mythril {
	private final float attackSpeed;

	public MythrilChakramItem(Tier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn) {
