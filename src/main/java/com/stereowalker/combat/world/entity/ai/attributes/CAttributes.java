...
public class CAttributes {
	...
	public static final Attribute MAX_MANA = register("generic.max_mana", (new RangedAttribute("attribute.name.combat.max_mana", 20.0D, 0.0D, 10240.0D)).setSyncable(true));
	public static final Attribute MAGIC_STRENGTH = register("generic.magic_strength", (new RangedAttribute("attribute.name.combat.magic_strength", 1.0D, 0.0D, 1024.0D)).setSyncable(true));
	public static final Attribute MANA_REGENERATION = register("generic.mana_regeneration", (new RangedAttribute("attribute.name.combat.mana_regeneration", 1.0D, 0.0D, 1024.0D)).setSyncable(true));
	...
	public static final Attribute LIGHTNING_RESISTANCE = register("generic.lightning_resistance", (new RangedAttribute("attribute.name.combat.lightning_resistance", 0.0D, 0.0D, 1024.0D)).setSyncable(true));
	public static final Attribute WIND_RESISTANCE = register("generic.wind_resistance", (new RangedAttribute("attribute.name.combat.wind_resistance", 0.0D, 0.0D, 1024.0D)).setSyncable(true));
	public static final Attribute ATTACK_REACH = register("generic.attack_reach", (new RangedAttribute("attribute.name.combat.attack_reach", 2.5D, 0.0D, 1024.0D)).setSyncable(true));
