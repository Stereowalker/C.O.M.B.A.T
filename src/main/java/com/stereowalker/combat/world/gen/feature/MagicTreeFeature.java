...
public class MagicTreeFeature extends Feature<BaseTreeFeatureConfig> {
	...
	public MagicTreeFeature(Codec<BaseTreeFeatureConfig> p_i231999_1_) {
		super(p_i231999_1_);
	}
	...
	private static boolean isDirtOrFarmlandAt(IWorldGenerationBaseReader p_236418_0_, BlockPos p_236418_1_) {
		return p_236418_0_.hasBlockState(p_236418_1_, (p_236409_0_) -> {
			...
			return block == CBlocks.ELYCEN_BLOCK || block == CBlocks.CALTAS || block == Blocks.FARMLAND;
		});
	}
	 ...
	 */
	 ...
	 public final boolean generate(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, BaseTreeFeatureConfig p_241855_5_) {
		 ...
		 if (mutableboundingbox.minX <= mutableboundingbox.maxX && flag && !set.isEmpty()) {
			 ...
			 Template.updatePostProcessing(p_241855_1_, 3, voxelshapepart, mutableboundingbox.minX, mutableboundingbox.minY, mutableboundingbox.minZ);
			 return true;
		 } else {
			 return false;
		 }
