...
public class ManaGeneratorMenu extends AbstractContainerMenu {
   ...
   public ManaGeneratorMenu(int id, Inventory playerInventory) {
      this(id, new SimpleContainer(1), playerInventory, new SimpleContainerData(4));
   }

   public ManaGeneratorMenu(int id, Container crateInventory, Inventory playerInventory, ContainerData p_i50104_6_) {
      super(CMenuType.MANA_GENERATOR, id);
      checkContainerSize(crateInventory, 1);
      checkContainerDataCount(p_i50104_6_, 1);
