...
public class BiomeCTags {
	public static final TagKey<Biome> IS_ACROTLEST = BiomeTags.create("combat:is_acrotlest");
	...
	public static final TagKey<Biome> HAS_ETHERION_TOWER_BADLANDS = BiomeTags.create("combat:has_structure/etherion_tower_badlands");
	public static final TagKey<Biome> HAS_ETHERION_TOWER_DESERT = BiomeTags.create("combat:has_structure/etherion_tower_desert");
