...
public class ZombieFollowCasterGoal extends Goal {
   ...
   public ZombieFollowCasterGoal(ZombieMinionEntity tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
