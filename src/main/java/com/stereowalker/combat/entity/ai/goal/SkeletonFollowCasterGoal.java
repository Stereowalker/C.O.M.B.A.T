...
public class SkeletonFollowCasterGoal extends Goal {
   ...
   public SkeletonFollowCasterGoal(SkeletonMinionEntity tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
   ...
   public boolean shouldContinueExecuting() {
      return !this.navigator.noPath() && this.tameable.getDistanceSq(this.owner) > (double)(this.maxDist * this.maxDist);
   }
