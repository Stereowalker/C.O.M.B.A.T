...
public abstract class AbstractCustomArrowEntity extends AbstractArrowEntity {
	...
	public AbstractCustomArrowEntity(EntityType<? extends AbstractCustomArrowEntity> entityIn, World worldIn) {
		super(entityIn, worldIn);
	}

	public AbstractCustomArrowEntity(EntityType<? extends AbstractCustomArrowEntity> entityIn, World worldIn, double x, double y, double z) {
		super(entityIn, x, y, z, worldIn);
	}

	public AbstractCustomArrowEntity(EntityType<? extends AbstractCustomArrowEntity> entityIn, World worldIn, LivingEntity shooter) {
