...
//----------------------------------------[Fire]----------------------------------------\\
	...
	//Apprentice
	public static final Spell FIRE_SKIN = register("fire_skin", new EffectSpell(SpellCategory.FIRE, Rank.APPRENTICE, 1.5F, Effects.FIRE_RESISTANCE, 0, 20));
...
//----------------------------------------[Water]----------------------------------------\\
	...
	//Apprentice
	public static final Spell WATER_BREATHING = register("water_breathing", new EffectSpell(SpellCategory.WATER, Rank.APPRENTICE, 2.5F, Effects.WATER_BREATHING, 0, 20));
...
//----------------------------------------[Restoration]----------------------------------------\\
	//Novice
	public static final Spell REGENERATION = register("regeneration", new EffectSpell(SpellCategory.RESTORATION, Rank.NOVICE, 1.64F, Effects.REGENERATION, 0, 20));
	//Apprentice
	...
	//Master
	public static final Spell AOE_HEALING = register("aoe_healing", new AOEEffectSpell(SpellCategory.RESTORATION, Rank.MASTER, 8.0F, 1, 20, () -> Effects.INSTANT_HEALTH, 2, true, 20));
	public static final Spell AOE_REGENERATION = register("aoe_regeneration", new AOEEffectSpell(SpellCategory.RESTORATION, Rank.MASTER, 8.0F, 1, 20, () -> Effects.REGENERATION, 2, true, 20));
//----------------------------------------[Conjuration]----------------------------------------\\
	//Basic
...
//----------------------------------------[Mind]----------------------------------------\\
	//Mind
	public static final Spell FEAR = register("fear", new AOEEffectSpell(SpellCategory.MIND, Rank.BASIC, 0.8F, 1, 20, () -> CEffects.FEAR, 1, false, 20));
//----------------------------------------[Nature]----------------------------------------\\
	//Novice
...
//----------------------------------------[Enhancement]----------------------------------------\\
	//Basic
	public static final Spell BASIC_SPEED_BOOST = register("basic_speed_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.BASIC, 0.6F, Effects.SPEED, 0, 20));
	public static final Spell BASIC_JUMP_BOOST = register("basic_jump_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.BASIC, 0.6F, Effects.JUMP_BOOST, 0, 20));
	public static final Spell BASIC_STRENGTH_BOOST = register("basic_strength_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.BASIC, 0.6F, Effects.STRENGTH, 0, 20));
	//Novice
	public static final Spell OAKFLESH = register("oakflesh", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.NOVICE, 1.2F, Effects.RESISTANCE, 0, 20));
	public static final Spell NOVICE_SPEED_BOOST = register("novice_speed_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.NOVICE, 1.2F, Effects.SPEED, 1, 20));
	public static final Spell NOVICE_JUMP_BOOST = register("novice_jump_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.NOVICE, 1.2F, Effects.JUMP_BOOST, 1, 20));
	public static final Spell NOVICE_STRENGTH_BOOST = register("novice_strength_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.NOVICE, 1.2F, Effects.STRENGTH, 1, 20));
	//Apprentice
	public static final Spell STONEFLESH = register("stoneflesh", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.APPRENTICE, 2.4F, Effects.RESISTANCE, 1, 20));
	public static final Spell APPRENTICE_SPEED_BOOST = register("apprentice_speed_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.APPRENTICE, 2.4F, Effects.SPEED, 2, 20));
	public static final Spell APPRENTICE_JUMP_BOOST = register("apprentice_jump_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.APPRENTICE, 2.4F, Effects.JUMP_BOOST, 2, 20));
	public static final Spell APPRENTICE_STRENGTH_BOOST = register("apprentice_strength_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.APPRENTICE, 2.4F, Effects.STRENGTH, 2, 20));
	//Advanced
	public static final Spell IRONFLESH = register("ironflesh", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.APPRENTICE, 4.8F, Effects.RESISTANCE, 2, 20));
	public static final Spell ADVANCED_SPEED_BOOST = register("advanced_speed_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.APPRENTICE, 4.8F, Effects.SPEED, 3, 20));
	public static final Spell ADVANCED_JUMP_BOOST = register("advanced_jump_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.APPRENTICE, 4.8F, Effects.JUMP_BOOST, 3, 20));
	public static final Spell ADVANCED_STRENGTH_BOOST = register("advanced_strength_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.APPRENTICE, 4.8F, Effects.STRENGTH, 3, 20));
	//Master
	public static final Spell DIAMONDFLESH = register("diamondflesh", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.MASTER, 9.6F, Effects.RESISTANCE, 3, 20));
	public static final Spell MASTER_SPEED_BOOST = register("master_speed_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.MASTER, 9.6F, Effects.SPEED, 4, 20));
	public static final Spell MASTER_JUMP_BOOST = register("master_jump_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.MASTER, 9.6F, Effects.JUMP_BOOST, 4, 20));
	public static final Spell MASTER_STRENGTH_BOOST = register("master_strength_boost", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.MASTER, 9.6F, Effects.STRENGTH, 4, 20));
	//God
	public static final Spell GOD_SKIN = register("god_skin", new EffectSpell(SpellCategory.ENHANCEMENT, Rank.GOD, 40.0F, Effects.RESISTANCE, 200, 20));
	//----------------------------------------[Blood]----------------------------------------\\
