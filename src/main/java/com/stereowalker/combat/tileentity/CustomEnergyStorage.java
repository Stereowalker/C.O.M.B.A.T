...
public class CustomEnergyStorage extends EnergyStorage {
	AbstractEnergyContainerTileEntity te;

	public CustomEnergyStorage(int capacity, int maxReceive, int maxExtract, int energy, AbstractEnergyContainerTileEntity te) {
