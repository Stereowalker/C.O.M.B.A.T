package com.stereowalker.old.combat.world.gen;
...
//
//public class AcrotlestChunkGenerator extends NoiseChunkGenerator<AcrotlestGenSettings> {
...
//
//   public AcrotlestChunkGenerator(IWorld worldIn, BiomeProvider provider, AcrotlestGenSettings settingsIn) {
...
//   }
//
//   protected void fillNoiseColumn(double[] moiseColumn, int noiseX, int noiseZ) {
//      this.calcNoiseColumn(moiseColumn, noiseX, noiseZ, (double)684.412F, (double)684.412F, 8.555149841308594D, 4.277574920654297D, 3, -10);
//   }
//
...
//      float f3 = this.biomeProvider.getNoiseBiome(noiseX, sea, noiseZ).getDepth();
//
//      for(int j = -2; j <= 2; ++j) {
//         for(int k = -2; k <= 2; ++k) {
//            Biome biome = this.biomeProvider.getNoiseBiome(noiseX + j, sea, noiseZ + k);
...
//      this.phantomSpawner.tick/*spawnMobs*/(worldIn, spawnHostileMobs, spawnPeacefulMobs);
