...
public class PlayerSkills {
	public static boolean hasSkill(LivingEntity entity, Skill skill) {
		if(entity != null) {
			CompoundNBT compound = getRankSkillNBT(entity);
			return compound.getBoolean(skill.getRegistryName().getPath());
		}
		return false;
	}
	
	public static Skill getStartingSkill(PlayerEntity player) {
		if (player != null) {
			CompoundNBT compoundNBT = getRankSkillNBT(player);
			return SkillUtil.getSkillFromNBT(compoundNBT, "StartingSkill");
		}
		return Skills.EMPTY;
	}
	
	public static void setStartingSkill(PlayerEntity player, Skill skill) {
		CompoundNBT compound = getRankSkillNBT(player);
		compound.putString("StartingSkill", skill.getKey());
	}
	
	public static void setSkill(PlayerEntity player, Skill skill, boolean flag) {
		CompoundNBT compound = getRankSkillNBT(player);
	...
	public static SkillGrantAction grantSkill(PlayerEntity player, Skill skill, boolean grantSkill) {
	...
	public static void grantRandomSkill(PlayerEntity player) {
	...
	public static Skill generateRandomSkill(PlayerEntity player, boolean onlyStartSkills) {
...
//		}
	...
	public static boolean revokeSkill(PlayerEntity player, Skill skill) {
		if (!hasSkill(player, skill)) {
			return false;
		} else {
...
//	public static 
	...
	public static void addSkillsOnSpawn(PlayerEntity player) {
	...
	public static CompoundNBT getRankSkillNBT(Entity entity) {
		return entity.getPersistentData().getCompound(getRankSkillDataString());
	}

	public static CompoundNBT getOrCreateRankSkillNBT(PlayerEntity entity) {
		if (!entity.getPersistentData().contains(getRankSkillDataString(), 10)) {
			entity.getPersistentData().put(getRankSkillDataString(), new CompoundNBT());
		}
		return entity.getPersistentData().getCompound(getRankSkillDataString());
	}

	public static void setRankSkillNBT(CompoundNBT nbt, Entity entity) {
